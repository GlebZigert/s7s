...
point:="hosts/"+svc.devices[i].Stream.Accesspoint[0].Accesspoint
        ...
        fmt.Println(" ")
          ...
          if len(rcv.Objects)>0{
            ...
            for j:=0;j<len(svc.devices);j++    {
              ...
              point:="hosts/"+svc.devices[j].Stream.Accesspoint[0].Accesspoint
              ...
              for i := 0; i < len(rcv.Objects); i++ {
                ...
                if rcv.Objects[i].Name==point{
                  ...
                  if rcv.Objects[i].Type=="devicestatechanged"{
                    ...
                    prev_dev_state:=svc.devices[j].State
                    ...
                    var id int64
                    id,_=strconv.ParseInt(svc.devices[j].CameraId,10,64)
                    fmt.Println("id: ",id)
...
fmt.Printf("[current_dev_state] ",current_dev_state)
                    ...
                    if current_dev_state!=prev_dev_state{
                      ...
                      ee = append(ee, api.Event {
                                  ...
                                  DeviceId:   svc.devices[j].Id,
                                  Reason:     "NO REASON",
                                  DeviceName: svc.devices[j].Name,
                                  ServiceName: svc.Settings.Title,
                                  Reaction:   "REACTION",
                                  Time:       parseTime(time. Now().String()).Unix()})
                    }

                    if svc.devices[j].State=="alarm"{
                    ...
                    svc.devices[j].State=current_dev_state
...
//Берем айди камеры и текущее время                    
                    ...
                    fmt.Println("Name ",rcv.Objects[i].Name," id: ",svc.devices[j].Id," dt: ",dt.String())
...
//list с айдишниками камер и временм последней тревоги.
  var result bool
  result=svc.find_alert(svc.devices[j].Id,dt)
  ...
  if result==false{
          ...
          svc.Broadcast("ListDevices", svc.devices)      
      fmt.Println(" \n")
      fmt.Println(" \n")
      }
...
func Add_apiEvent(svc *Axxon){


fmt.Println("======================")
fmt.Println("=")
fmt.Println("=")
fmt.Println("[Add_apiEvent]")

fmt.Println("=")
fmt.Println("=")
fmt.Println("======================")   
  //svc.Log(">>> EA:", len(events))
 ee := make([]api.Event, 0, 1)
 ee = append(ee, api.Event {
            ExternalId: 1,
...
func My_Handler(ws *websocket.Conn) {
  fmt.Println("[My_Handler]")
}
...
if err:=websocket.JSON.Receive(conn,&rcv);err!=nil{
fmt.Println(err) 	
}else{
  fmt.Println("rcv: ",rcv)
  if len(rcv.Objects)>0{
...
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:1",
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:0",   
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:1",
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:0",
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:1", 
"hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:0",

"hosts/ASTRAAXXON/DeviceIpint.14/SourceEndpoint.video:0:0"}
...
*/
 ...
 /*   msg.include=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.14/SourceEndpoint.video:0:0")   

    msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:3:0")
    msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:1")
    msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:0")    
  msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:1")
  msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:0")
  msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:1")  
  msg.exclude=msg.include.append("hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:0") 
*/


//         "name" : "hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:3:1",\n


/*
  msg.Data=`"include":["+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:3:0","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:1","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:0","+     
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:1","+ 
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:0","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:1","+ 
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:0:0","+
               ""hosts/ASTRAAXXON/DeviceIpint.15/SourceEndpoint.video:0:0","+
               ""hosts/ASTRAAXXON/DeviceIpint.14/SourceEndpoint.video:0:0","+                            

  "],"exclude":["+

""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:3:1","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:3:0","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:1","+
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:2:0","+     
               ""hosts/ASTRAAXXON/DeviceIpint.16/SourceEndpoint.video:1:1","+ 
